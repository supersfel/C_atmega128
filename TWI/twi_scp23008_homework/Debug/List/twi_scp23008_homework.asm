...
; 0000 005D {
; 0000 005E 
; 0000 005F ret_err = TWI_Master_Receive_ExDevice(MCP23008ADDR, GPIO, &keyInput);
	RCALL SUBOPT_0x1
	IN   R26,SPL
	IN   R27,SPH
	PUSH R17
	...
	POP  R17
	MOV  R18,R30
; 0000 0060 if(ret_err == 0)
	CPI  R18,0
	BREQ PC+2
	RJMP _0x27
; 0000 0061 {
; 0000 0062 fnd = keyInput;
	MOV  R19,R17
; 0000 0063 keyOutput = (0x0F)|(fnd << 4);
	MOV  R30,R19
	SWAP R30
	ANDI R30,0xF0
	ORI  R30,LOW(0xF)
...
; 0000 0065 delay_ms(1);
	...
	LDI  R27,0
	RCALL _delay_ms
; 0000 0066 //ret_err = MCP23008_I2C_Write(MCP23008ADDR, GPIO, keyOutput);
; 0000 0067 switch(keyOutput)
	MOV  R30,R16
	LDI  R31,0
; 0000 0068 {
; 0000 0069 case 0b11101111:
	CPI  R30,LOW(0xEF)
	LDI  R26,HIGH(0xEF)
	CPC  R31,R26
	BRNE _0x2B
; 0000 006A ret_err = MCP23008_I2C_Write(MCP23008ADDR, GPIO, 0b01111111 << i);
	RCALL SUBOPT_0x1
	MOV  R30,R21
	LDI  R26,LOW(127)
	RCALL SUBOPT_0x2
; 0000 006B delay_ms(100);
; 0000 006C ret_err = MCP23008_I2C_Write(MCP23008ADDR, GPIO, 0b10111111 << i);
	MOV  R30,R21
	LDI  R26,LOW(191)
	RCALL SUBOPT_0x2
; 0000 006D delay_ms(100);
; 0000 006E ret_err = MCP23008_I2C_Write(MCP23008ADDR, GPIO, 0b11011111 << i);
	MOV  R30,R21
	LDI  R26,LOW(223)
	RCALL SUBOPT_0x2
; 0000 006F delay_ms(100);
; 0000 0070 ret_err = MCP23008_I2C_Write(MCP23008ADDR, GPIO, 0b11101111 << i);
	MOV  R30,R21
	LDI  R26,LOW(239)
	RJMP _0x34
...
; 0000 0073 
; 0000 0074 break;
; 0000 0075 case 0b11011111:
_0x2B:
	CPI  R30,LOW(0xDF)
	LDI  R26,HIGH(0xDF)
	CPC  R31,R26
	BRNE _0x2C
; 0000 0076 for(i = 0 ; i<4;i++)
	LDI  R21,LOW(0)
_0x2E:
	CPI  R21,4
	BRSH _0x2F
; 0000 0077 {
; 0000 0078 ret_err = MCP23008_I2C_Write(MCP23008ADDR, GPIO, 0b11101111 << i);
	RCALL SUBOPT_0x1
	MOV  R30,R21
	LDI  R26,LOW(239)
	RCALL __LSLB12
...
; 0000 007C break;
	RJMP _0x2A
; 0000 007D case 0b10111111:
_0x2C:
	CPI  R30,LOW(0xBF)
	LDI  R26,HIGH(0xBF)
	CPC  R31,R26
	BRNE _0x30
; 0000 007E ret_err = MCP23008_I2C_Write(MCP23008ADDR, GPIO, 0b01011111 << i);
	RCALL SUBOPT_0x1
	MOV  R30,R21
	LDI  R26,LOW(95)
	RCALL SUBOPT_0x2
; 0000 007F delay_ms(100);
; 0000 0080 ret_err = MCP23008_I2C_Write(MCP23008ADDR, GPIO, 0b10101111 << i);
	MOV  R30,R21
	LDI  R26,LOW(175)
	RJMP _0x34
...
; 0000 0082 
; 0000 0083 break;
; 0000 0084 case 0b01111111:
_0x30:
	CPI  R30,LOW(0x7F)
	LDI  R26,HIGH(0x7F)
	CPC  R31,R26
	BRNE _0x32
; 0000 0085 ret_err = MCP23008_I2C_Write(MCP23008ADDR, GPIO, 0b11111111 << i);
	RCALL SUBOPT_0x1
	MOV  R30,R21
	LDI  R26,LOW(255)
	RCALL SUBOPT_0x2
; 0000 0086 delay_ms(100);
; 0000 0087 ret_err = MCP23008_I2C_Write(MCP23008ADDR, GPIO, 0b00001111 << i);
	MOV  R30,R21
	LDI  R26,LOW(15)
	RJMP _0x34
...
; 0000 008B default:
_0x32:
; 0000 008C ret_err = MCP23008_I2C_Write(MCP23008ADDR, GPIO, 0b11111111 << i);
	RCALL SUBOPT_0x1
	MOV  R30,R21
	LDI  R26,LOW(255)
_0x34:
