...
_0x22:
	.DB  0x53,0x6C,0x61,0x76,0x65,0x20,0x52,0x65
	.DB  0x63,0x2E,0x20,0x3A,0x20,0x0
_0x0:
...
_main:
; .FSTART _main
; 0000 0018 unsigned char str[] = "Slave Rec. : ";
; 0000 0019 Init_SPI_Slave_IntContr();
	SBIW R28,14
	LDI  R24,14
	__GETWRN 22,23,0
	LDI  R30,LOW(_0x22*2)
...
; 0000 001A LCD_Init();
	RCALL _LCD_Init
; 0000 001B LCD_Pos(0,0);
	LDI  R30,LOW(0)
	ST   -Y,R30
	LDI  R26,LOW(0)
	RCALL _LCD_Pos
; 0000 001C LCD_Str(str);
	MOVW R26,R28
	RCALL _LCD_Str
; 0000 001D 
; 0000 001E while (1)
...
; 0000 0021 LCD_Pos(0,13);
	LDI  R30,LOW(0)
	ST   -Y,R30
	LDI  R26,LOW(13)
	RCALL _LCD_Pos
; 0000 0022 LCD_Char(SPI_Rec_Char);
	MOV  R26,R6
	RCALL _LCD_Char
